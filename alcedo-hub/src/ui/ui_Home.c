...
lv_obj_t * ui_Temperture = NULL;
lv_obj_t * ui_Label3 = NULL;
lv_obj_t * ui_Label5 = NULL;
lv_obj_t * ui_Temperture1 = NULL;
lv_obj_t * ui_Label1 = NULL;
lv_obj_t * ui_Label2 = NULL;
lv_obj_t * ui_Temperture2 = NULL;
...
void ui_event_Button2(lv_event_t * e)
{
    ...
    if(event_code == LV_EVENT_CLICKED) {
        _ui_screen_change(&ui_ScreenLight, LV_SCR_LOAD_ANIM_MOVE_LEFT, 200, 0, &ui_ScreenLight_screen_init);
    }
}
...
void ui_event_Button3(lv_event_t * e)
{
    ...
    if(event_code == LV_EVENT_CLICKED) {
        _ui_screen_change(&ui_ScreenAircon, LV_SCR_LOAD_ANIM_MOVE_LEFT, 200, 0, &ui_ScreenAircon_screen_init);
    }
}
...
void ui_event_Button5(lv_event_t * e)
{
    ...
    if(event_code == LV_EVENT_CLICKED) {
        _ui_screen_change(&ui_ScreenCurtain, LV_SCR_LOAD_ANIM_MOVE_LEFT, 200, 0, &ui_ScreenCurtain_screen_init);
    }
}
